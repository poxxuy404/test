...
const $$splitComponentImporter$2 = () => import("./index-DMC4lSXl.js");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "HTML, CSS va JavaScript bo'yicha amaliy test platformasi."
    }]
  }),
...
const TestTypeRoute = Route$1.update({
  id: "/test/$type",
  path: "/test/$type",
  getParentRoute: () => Route$4
});
const ResultTypeRoute = Route.update({
  id: "/result/$type",
  path: "/result/$type",
  getParentRoute: () => Route$4
});
